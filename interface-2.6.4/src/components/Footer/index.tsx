          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-4/12 xl:w-6/12">
              <div
                ...
                data-wow-delay=".2s"
              >
                <a href="index.php" className="mb-8 inline-block">
                  <img
                    src="theme/images/apelogo.png"
                    alt="logo"
                ...
                <p className="text-base text-body">
                  One-Stop decentralized Trading on APE CHAIN.
                </p>
              </div>
            </div>
                ...
                <div className="w-full px-4 sm:w-1/2 md:w-4/12 lg:w-4/12">
                  <div className="wow fadeInUp mb-11" data-wow-delay=".25s">
                    ...
                    <ul className="space-y-[10px]">
                      <li>
                        <a
                          href="https://forms.gle/1Cip4hJT3JmfAGH7A"
                          target="_blank"
                      ...
                      <li>
                        <a
                          href="https://forms.gle/XQ3DbmSKrrsZZYxD8"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-block text-base text-body hover:text-primary"
                        >
          ...
          <div className="-mx-3 flex flex-wrap">
            <div className="order-last w-full px-3 lg:order-first lg:w-1/3">
              <p className="mt-4 text-center text-base text-white lg:mt-0 lg:text-left">
                &copy; 2024-25 ApeFiSwap. All rights reserved
              </p>
            </div>
            <div className="w-full px-3 md:w-1/2 lg:w-1/3">
              <div className="mb-4 flex items-center justify-center space-x-5 md:mb-0 md:justify-start lg:justify-center">
                <a href="javascript:void(0)" className="text-white opacity-70 hover:opacity-100" aria-label="social icon">
            ...
            <div className="w-full px-3 md:w-1/2 lg:w-1/3">
              <div className="flex items-center justify-center space-x-4 sm:space-x-8 md:justify-end lg:justify-end">
                <a href="javascript:void(0)" className="text-base text-white"> Privacy Policy </a>
                <a href="javascript:void(0)" className="text-base text-white"> Terms and conditions </a>
              </div>
            </div>
          </div>
        </div>
